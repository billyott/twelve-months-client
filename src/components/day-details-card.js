        ...
        return(
            <div className="day-details-card">
                <div className="day-details-card__left-container">
                    ...
                    <button className="day-details-card__button" onClick={this.handleShowNewNoteForm}>{this.state.showAddNoteForm ? <i class="times icon"></i> : <i class="plus icon"></i>}</button>
                </div>
